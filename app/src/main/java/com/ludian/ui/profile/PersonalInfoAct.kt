...
import com.ludian.R
import com.ludian.databinding.ActivityPersonalInfoBinding
...
@AndroidEntryPoint
class PersonalInfoAct : AppCompatActivity() {
    private lateinit var binding : ActivityPersonalInfoBinding
    private lateinit var userDataViewModel: UserDataViewModel

    private var userId : String? = null
    private var image : String? = null
    private val sharedPrf by lazy { SharedPrf(this@PersonalInfoAct) }
    ...
    private fun initViews() {
        ...
        if(intent!=null){
            ...
            Glide.with(this@PersonalInfoAct)
                .load(image)
        ...
        binding.btnSave.setOnClickListener {
            ...
            if (validationResult.first) {
                Helper.showProgressMessage(this@PersonalInfoAct,getString(R.string.please_wait))
                val token =
    ...
    private fun showValidationErrors(error: String) {
        ...
        Toast.makeText(this@PersonalInfoAct,text, Toast.LENGTH_SHORT).show()
    }
    ...
    private fun dialogForImagePick() {
        ...
        val builder = AlertDialog.Builder(this@PersonalInfoAct)
            ...
            if (result.resultCode == Activity.RESULT_OK) {
                ...
                try {
                    if (data != null) {
                        ...
                        val tempUri: Uri = Helper.getImageUri(this@PersonalInfoAct, bitmapNew)!!
                        val image = RealPathUtil.getRealPath(this@PersonalInfoAct, tempUri)
    ...
    private val pickFromGallery =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == Activity.RESULT_OK) {
                ...
                val path: String = RealPathUtil.getRealPath(this@PersonalInfoAct, data!!.data)!!
                //   val imageBitmap: Bitmap =
                //        BITMAP_RE_SIZER(bitmapNew!!, bitmapNew.width, bitmapNew.height)!!
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == 1000) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this@PersonalInfoAct, R.string.permission_denied, Toast.LENGTH_LONG)
                    .show()
